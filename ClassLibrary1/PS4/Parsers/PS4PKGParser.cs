    ...
    public class PS4PKGParser : IRomParser
    {
            ...
            public Task<List<Rom>> ProcessFile(string path)
        {
            ...
            catch (Exception)
            {
                ...
                return Task.FromResult(new List<Rom>());throw;
            }
            Rom ps4rom;
         ...
         if (t.Name is not null)
            ...
            {
                ps4rom.Images = new List<string>() { BinUtils.ByteArrayToPrefixedString(ps4Pkg.Image2) };
            }

            ps4rom.Path = path;
            ps4rom.TitleName = ps4Pkg.PS4_Title;
