...
namespace DotNet3dsToolkit.Ctr
{
    public class TmdMetadata
    {
        ...
        private async Task Initalize()
        {
            ...
            //title version must be ushort, it overflows with smash bros update 1.1.7
            //TitleVersion = await TmdData.ReadInt16BigEndianAsync(afterSignatureOffset + 0x9C);
            TitleVersion =  TmdData.ReadUInt16BigEndian(afterSignatureOffset + 0x9C);
        ...
        public ushort TitleVersion { get; set; } // Index: X + 0x9C, size: 2
