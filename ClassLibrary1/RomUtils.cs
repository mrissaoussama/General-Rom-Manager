...
namespace RomManagerShared
{
    ...
    {
        public static void CopyIRomProperties(IRom source, IRom destination)
        {
        ...
        public static void OrganizeRomsInFolders(List<IRom> romList)
        {
            ...
            IGame firstGame = romList.OfType<IGame>().FirstOrDefault();
