...
{//https://github.com/feudalnate/Original-Xbox-Data-Structures/blob/master/Xbox%20Executable/XBE.cs#L62
    ...
    {//constants
        ...
        {
            using (MemoryStream stream = new MemoryStream(xbeContent))
        ...
        {
            XBE_HEADER header = new XBE_HEADER();
            header.Magic = reader.ReadUInt32();
            header.Signature = reader.ReadBytes((int)CONST_RSA_SIGNATURE_SIZE);
            header.BaseAddress = reader.ReadUInt32();
            header.SizeOfHeaders = reader.ReadUInt32();
            header.SizeOfImage = reader.ReadUInt32();
            header.SizeOfImageHeader = reader.ReadUInt32();
            header.TimeStamp = reader.ReadUInt32();
            header.Certificate = reader.ReadUInt32();
        ...
        {
            XBE_CERTIFICATE certificate = new XBE_CERTIFICATE();
            certificate.SizeOfCertificate = reader.ReadUInt32();
            certificate.TimeStamp = reader.ReadUInt32();
            certificate.TitleID = reader.ReadUInt32();
            certificate.TitleName = ReadUnicodeString(reader, CONST_TITLE_NAME_LENGTH);
            certificate.AlternateTitleIDs = ReadUInt32Array(reader, CONST_MAX_ALTERNATE_COUNT);
