...
public class RomMissingUpdates
{
    ...
    {
    }    public RomMissingUpdates(Rom gameRom, List<Update>? localUpdates, Update? latestUpdate)
    {
        Rom = gameRom;
        LocalUpdates = localUpdates;
        LatestUpdate = latestUpdate;
    }    public Rom? Rom { get; set; }
    public List<Update>? LocalUpdates { get; set; }
...
public class RomMissingDLCs
{
    ...
    public List<DLC>? LocalDLCs { get; set; }
    public List<DLC>? MissingDLCs { get; set; }
    public override string ToString()
    {
        var report = $"Rom: {Rom} {Environment.NewLine}";
